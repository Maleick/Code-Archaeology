...
```bash
npm install -g opencode-code-archaeology@2.8.1 && opencode-code-archaeology install && opencode-code-archaeology doctor
```

Or tell OpenCode:

```text
Fetch and follow the instructions in the installed package's INSTALL.md at $(npm root -g)/opencode-code-archaeology/INSTALL.md for opencode-code-archaeology@2.8.1
```
